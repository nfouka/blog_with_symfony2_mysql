...
$catalogue = new MessageCatalogue('fr', array (
  ...
  array (
    ...
    'project' => '1ère Application avec Symfony2',
    'Hello' => 'Bonjour %name% !',
    'Bye' => 'Au revoir',
    'Nevermind' => 'On s\'en fout',
    'site.name' => 'Mon site',
    'article.list' => 'List des articles',
    'article.empty' => 'Pas (encore !) d\'articles disponibles',
    'article.donnee.0' => 'Le Site du Zéro recueille des informations (login, e-mail) lors de votre enregistrement en tant que membre du site. Lors de votre connexion au site, un fichier "log" stocke les actions effectuées par votre ordinateur (via son adresse IP) au serveur.
',
    'article.donnee.1' => 'Lorsque que vous vous connectez en tant que membre du Site du Zéro et
...
d\'autres fins.
',
    'article.donnee.2' => 'Merci de votre attention.',
    'article.nombre' => 'Il y a %count% article|]1,+Inf]Il y a %count% articles',
  ),
));
